...
class PJCustomNaviBar: UIView {
    ...
    override init(frame: CGRect) {
        ...
        configUI()
        self.frame = CGRect(0, 0, kScreenWidth, kTopHeight);
        // 默认背景色 白色
...
//
//        rightStackV.setContentHuggingPriority(.required, for: .horizontal)
//        rightStackV.setContentCompressionResistancePriority(.defaultLow, for: .horizontal)
